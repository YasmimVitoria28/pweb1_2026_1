...
<head>
    ...
    <title>Listagem de Produtos - Grão de Ouro</title>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom-coffee">
                <h1 class="h2 title-coffee">
                    <i class="bi bi-cup-hot me-2"></i>Listagem de Produtos
                </h1>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <a href="ProdutosForm.php" class="btn btn-coffee-success btn-lg">
                        <i class="bi bi-plus-lg me-2"></i>Novo Produto
                    </a>
                </div>
                <div class="col-md-6">
                    <form action="ProdutoList.php" method="GET" class="form-coffee">
                        <div class="input-group">
                            ...
                            <?php if (!empty($busca)): ?>
                                <a href="ProdutoList.php" class="btn btn-coffee-primary">
            ...
            <div class="card card-status">
                <div class="card-header card-status-header">
                    ...
                    <?= !empty($busca) ? "Resultados para: \"$busca\"" : "Todos os Produtos" ?>
                </div>
                            ...
                            <tbody>
                                ...
                                if (!empty($produtos)) {
                                    foreach($produtos as $p) {
                                        if (!empty($busca) && stripos($p->nome, $busca) === false) {
                                            continue;
                                        }
                                        $encontrou = true;
                                        ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    <a href="ProdutosForm.php?editar=<?= $p->id ?>" 
                                ...
                                if (!$encontrou) {
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-5">
                                            ...
                                            <p class="text-muted-coffee mb-2">Nenhum produto encontrado</p>
                                            <?php if (!empty($busca)): ?>
                                                <small style="color: #E8BC73;">
                                                    Nenhum resultado para "<strong><?= htmlspecialchars($busca) ?></strong>"
                                                </small>
                                                <br>
                                                <a href="ProdutoList.php" class="btn btn-coffee-primary btn-sm mt-2">
                                                    <i class="bi bi-arrow-left me-1"></i> Voltar para lista completa
                                                </a>
                                            <?php else: ?>
                                                <a href="ProdutosForm.php" class="btn btn-coffee-success btn-sm mt-2">
                                                    <i class="bi bi-plus-lg me-1"></i> Criar primeiro produto
                                                </a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                ...
                <div class="card-footer" style="background-color: #2a0810; border-top: 1px solid #C2933C;">
                    <div class="d-flex justify-content-between align-items-center">
                        <small style="color: #E8BC73;">
                            ...
                            echo "Mostrando $total produto(s)";
                            ?>
                        </small>
                    </div>
                </div>
